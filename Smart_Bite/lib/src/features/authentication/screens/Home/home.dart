      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(
            ...
            label: 'Profile',
            backgroundColor:
                Colors.red, // set the background color for this item
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.search_sharp),
            label: 'Search',
            backgroundColor:
                Colors.green, // set the background color for this item
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.qr_code_scanner_outlined),
            label: 'Scanner',
            backgroundColor:
                Colors.blue, // set the background color for this item
          ),
        ],
      ),
    );
